...
vim.keymap.set("n", "<Leader>bc", function() ese_command(nil, "*command*") end, { desc = "Run a command in the command buffer" })
vim.keymap.set("n", "<Leader>br", function() ese_command("rg --follow --vimgrep --smart-case ", "*ripgrep*") end, { desc = "Quick view: ripgrep through files" })
vim.keymap.set("n", "<Leader>bf", function() ese_command("rg --follow --files ", "*files*") end, { desc = "Quick view: ripgrep files" })
vim.keymap.set("n", "<Leader>bl", function() ese_command("ls -la ", "*listing*") end, { desc = "Quick view: directory listing" })
