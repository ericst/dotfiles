...
Let's see how that freanking auto-fill mode works. I am actually wondering if it   
and if I add stuf here wask a goo idea... mmmmh it seems like so. and what about
those stupdide liitll things like having the fill mode work for me
...
** Org
*** Personal Bindings
Some personal binding for org-mode.

| Key Binding | Description                  |
|-------------+------------------------------|
| ~SPC m o e~ | Execute current source block |
| ~SPC m o i~ | Toggle in-line images        |
...
**** Todos
One type of todos, is the the type I use for my personal todos. It has a rather
easy sequence diagram that goes like this:

[[file:images/todos.png]]

**** Tasks
The other type of todos is the one I use for keeping track of projects. This is
better described in my dashboards. Here is what the sequence diagram looks like: 

[[file:images/tasks.png]]

For more details on them. Please refer to the dashboard descriptions.
* Emacs
